class Screen2 {
  Platform pltGrnd, pltTop, pltLeft, pltRight, plt1;
  Wall wNextRight;
  //Sprite sprBill;
  String sFile;
  ...
  int nSideUD, nSideLR, nSideUD2, nSideLR2, nSideUD3, nSideLR3, nSideUD4, nSideLR4, nSideUD5, nSideLR5;
  ...
  Screen2() {
    ...
    wNextRight = new Wall("wall.png", 0, 500, 20, 750);

    pltGrnd = new Platform("plank.png", 0, 750, 1200, 50);
    pltTop = new Platform("plank.png", 0, 0, 1200, 50);
    pltLeft = new Platform("plank.png", 0, 50, 50, 500);
    pltRight = new Platform("plank.png", 1150, 50, 50, 700);

    plt1 = new Platform("plank.png", 600, 600, 50, 50);
  }
  // =============================== UPDATE ================================
  void update() {
