class Platform {
  ...
  Platform( String _sFile, int _nX, int _nY, int _nH, int _nW) {
    ...
    wallTop = new Wall("Nothing.png", nX+10, nY, 10, nW-20);
    wallBot = new Wall("Nothing.png", nX+10, nY+ nH -10, 10, nW-20);
    wallLeft = new Wall("Nothing.png", nX, nY, nH, 10);
    wallRight = new Wall("Nothing.png", nX + nW -10, nY, nH, 10);
  }
