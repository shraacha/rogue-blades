class Platform {
  ...
  //============================= NHIT/COLLISION DIRECTION UP AND DOWN SPRITE =============================
  public int nHitUD(Sprite s) { // 1 top, 2 bottom, 3 left, 4 right
    if (isHitS(s, wallTop)) {
      return 1;
    } else if (isHitS(s, wallBot)) {
      return 2;
    } else return 0;
  }
  //============================= NHIT/COLLISION DIRECTION LEFT & RIGHT SPRITE =============================
  public int nHitLR(Sprite s) {
    if (isHitS(s, wallLeft)) {
      return 3;
    } else if (isHitS(s, wallRight)) {
      return 4;
    } else return 0;
  }
  //============================= NHIT/COLLISION DIRECTION UP AND DOWN ENEMY =============================
  public int nHitUDE(Enemy e) { // 1 top, 2 bottom, 3 left, 4 right
    if (isHitE(e, wallTop)) {
      return 1;
    } else if (isHitE(e, wallBot)) {
      return 2;
    } else return 0;
  }
  //============================= NHIT/COLLISION DIRECTION LEFT & RIGHT ENEMY =============================
  public int nHitLRE(Enemy e) {
    if (isHitE(e, wallLeft)) {
      return 3;
    } else if (isHitE(e, wallRight)) {
      return 4;
    } else return 0;
  }
  // ============================= IS-HIT =============================
  boolean isHitS(Sprite one, Wall two) {
  ...
  // ============================= IS-HIT ENEMY =============================
  boolean isHitE(Enemy one, Wall two) {
    float fX1, fY1, fX2, fY2;
    int nH1, nW1, nH2, nW2;
    fX1 = one.fX;
    fY1 = one.fY; 
