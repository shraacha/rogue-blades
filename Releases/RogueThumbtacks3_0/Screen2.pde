class Screen2 {
  ...
  int  nStart = 0, nExit = 2, nReEnter = 1;
  ...
  Screen2() {
    ...
    wLastLeft = new Wall("purpWall.png", 0, 500, 20, 750);
    ...
    plt1 = new Platform("plank.png", 300, 600, 100, 50);
